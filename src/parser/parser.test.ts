...
Deno.test("parser: expressions", async (t) => {
  ...
  await t.step("expression in parens", () =>
    textExpression("(123);", { type: "number", value: 123 })
  );

  await t.step("literals", async (t) => {
    ...
    await t.step("parses object literal - with properties", () =>
  ...
  await t.step("arrow function", async (t) => {
    await t.step("parses basic function expression", () =>
      textExpression("(() => {});", {
        type: "function",
        parameters: [],
...
Deno.test("parser: statement", async (t) => {
  await t.step("variable declaration", async (t) => {
  ...
  await t.step("function declaration", async (t) => {
  ...
  await t.step("import / export", async (t) => {
